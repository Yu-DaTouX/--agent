...
| **N22 右栏项目文件改版** | 待确认范围 | 按参考图重做右栏文件区的视觉语言（行高 26px、缩进 14px/级、hover 圆角高亮、选中左侧强调条、项目头、超 50 项「展开显示」），懒加载/预览/加入上下文/搜索/身份校验一行不改；方案：[design/方案-右栏项目文件](../design/方案-右栏项目文件-2026-09-15.md)。开工前需确认：只改右栏还是连左栏一起统一。 |
